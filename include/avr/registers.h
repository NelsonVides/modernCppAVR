...
namespace vAVR {
     ...
     * * This class provides safe access to a bit in a given register. It ensures that the bit index is valid and causes a compile error otherwise.
    ...
    template<ptrdiff_t Address,
        ...
        ptrdiff_t EffectiveAddress = Base + Address>
            class special_function_register
            {
                 ...
                 * * @see stl::internal::registers::rw_special_function_register::set
                 * */
    ...
    template<ptrdiff_t Address,
        ...
        {
            static_assert(stl::in_range(special_function_register<Address, 0x20, Bits, ValidBits>::address, 0x20, 0x5f),
     ...
     * * @since 1.0.0
     * */
    template<ptrdiff_t Address, stl::int_types::uint_for_size_t<8> Bits, stl::int_types::uint_for_size_t<Bits> ValidBits>
